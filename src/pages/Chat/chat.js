          ...
          <div class="chat">
            ...
            <div class="messages" id="chat">
              ...
              <div class="message parker">
                Hey, man! What's up, Tola? 👋
              </div>
              <div class="message stark">
                Good Tri, where are u going?
              </div>
              <div class="message parker">
                Field trip! 🤣
              </div>
              <div class="message parker">
                I want to swap my blue shirt for your gray short, is okay ? 🤔
              </div>
              <div class="message stark">
                Sure bro, where we gonna meet, and also what's time?
              </div>
              <div class="message stark">
